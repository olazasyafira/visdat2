...
# --- STREAMLIT SELECTION
environtment = df['Environtment'].unique().tolist()
...
environtment_selection = st.multiselect('Environtment:',
                                    environtment,
                                    default=environtment)

# --- FILTER DATAFRAME BASED ON SELECTION
mask = (df['Age'].between(*age_selection)) & (df['Environtment'].isin(environtment_selection))
